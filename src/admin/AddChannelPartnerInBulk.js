...
import { createPartnerInBulk } from "./helper/partnerapicalls";

const AddChannelPartnerInBulk = () => {
  ...
  const onSubmit = (event) => {
    ...
    createPartnerInBulk(user._id, token, formData)
      .then((data) => {
        if (data.error) {
          setValues({
            ...values,
...
export default AddChannelPartnerInBulk;
